...
// -----------------------------------------------------------------------------
// MUSCL-Hancock interface fluxes
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// First-order advance: configurable Riemann solver
// -----------------------------------------------------------------------------
...
// Backward-compatible default: HLL
void advance_first_order(
    const Grid2D& Uold,
    Grid2D& Unew,
    double dt
...
//
// Configurable Riemann solver version.
// Mirrors advance_second_order_gpu conceptually:
